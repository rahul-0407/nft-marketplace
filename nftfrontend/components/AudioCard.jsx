...
const AudioCard = () => {
  ...
  return (
    <div className="grid grid-cols-5 grid-rows-[repeat(6,4rem)] gap-4 overflow-hidden rounded-3xl shadow-[var(--box-shadow)] relative">
      ...
      <div className="col-span-full row-start-1 row-end-2 flex justify-between z-20">
        ...
        <div
          ...
          className="bg-[var(--icons-color)] text-[var(--shadow-dark-color)] flex items-center gap-3 px-5 py-5 rounded-full cursor-pointer m-4"
        >
          {like ? (
        ...
        {/* Skewed Time */}
        <div className="bg-[var(--main-bg-color)] px-16 py-2 -mr-6 skew-x-[35deg] rounded-bl-2xl">
      ...
      <div className="col-span-full row-start-4 row-end-5 flex items-center gap-16 px-12 z-30">
        ...
        <div
          ...
          className="p-5 rounded-full bg-[var(--main-bg-color)] text-3xl cursor-pointer"
        >
      ...
      <div className="col-span-full row-start-5 row-end-[-1] z-20 flex justify-between items-center
                      bg-[var(--main-bg-color)] w-[90%] p-8 rounded-tr-3xl leading-tight">

        <div>
          <h4 className="text-lg leading-none">NFT music #1234</h4>

          <div className="border border-[var(--icons-color)] px-4  rounded-lg h-12 cursor-pointer mt-2">
            <small className="bg-[var(--icons-color)] text-[var(--main-bg-color)] px-2 py-1 rounded-md text-xs">
              Price
            </small>
